...
async function main() {
  ...
  await wethApproveToSeaportCheck(signer);
}
async function wethApproveToSeaportCheck(signer) {
  const WethContract = new ethers.Contract(
    WethContractAddress,
    WethAbi,
    signer
  );
  const res = await WethContract.allowance(signer.address, SeaportAddress);
  console.log({ res });
}
